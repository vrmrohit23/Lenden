  ...
  return (
    <>
      <section  className={`${viewstate ? 'flex ' : 'hidden'}  fixed justify-center inset-0 items-center  w-full h-full z-50`}>
        <div className={`  relative  mx-3 border-2 border-double  border-amber-500 max-h-screen w-full overflow-auto md:w-3/5 lg:w-2/5  sm:mx-5 `}>
        ...
        <form onSubmit={handleSubmit(formsubmit)}>
          <div className='bg-white px-2 pt-4 pb-2 sm:px-10 sm:pb-5 sm:pt-10'>
            <div className=''>
              <div className='w-full bg-sky-200 px-4 py-4 border-2 border-blue-500  mb-5 md:mb-0'>
            ...
            <div className='flex justify-end mt-5 '>
              ...
              <Commonbutton text={'Cancel'} onClick={() => { setviewstate(false); 

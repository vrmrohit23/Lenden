...
function Expenserows({ expense, seteditdetails, setviewstate,setdetails}) {
  ...
  return (
    <tr >
      ...
      <td title='Open Description' className='border-  text-center bg-gray-700 border-gray-100 hover:bg-slate-800 hover:border-orange-600 cursor-pointer' onClick={()=>{setdetails(expense.Desc || 'empty')}}> <span className=' text-white   text-base sm:px-2 sm:text-xl' ><FontAwesomeIcon icon={"fa-solid fa-plus"}/>
      </span></td>
